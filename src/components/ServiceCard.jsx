...
const ServiceCard = ({ imgURL, label, subtext, techs }) => {
  return (
    <div className='flex-1 sm:w-[350px] sm:min-w-[350px] w-full rounded-[20px] shadow-3xl px-5 py-8'>
      ...
      <p className='my-3 break-words font-montserrat text-lg leading-normal text-slate-gray'>
        {subtext}
      </p>
