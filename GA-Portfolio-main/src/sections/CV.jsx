  ...
  return (
    ...
    >
      ...
      <div className="text-center space-y-4">
        <h3 className="text-4xl max-sm:text-3xl font-palanquin font-bold dark:text-white">
          {t("cv.title_part1")}{" "}
          <span className="text-coral-red">{t("cv.title_part2")}</span>
        </h3>
        <p className="text-lg text-slate-gray max-w-2xl mx-auto dark:text-slate-300">
          {t("cv.subtitle")}
        </p>
      </div>
        ...
        <div className="flex flex-col items-center gap-6 max-w-[500px] w-full text-center">
          <div className="space-y-4">
            <h3 className="text-4xl max-sm:text-3xl font-palanquin font-bold dark:text-white">
              ...
              <span className="text-coral-red">{t("cv.thank_you_part2")}</span>
            </h3>
            <p className="text-xl text-slate-gray dark:text-slate-300">
